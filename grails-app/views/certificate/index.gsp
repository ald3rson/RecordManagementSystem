    ...
    <body>
        ...
        <a href="#list-certificate" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
            <div class="ui secondary pointing menu">
              <a class="item active"><h3>TEC Certificate List</h3></a>
              <div class="right menu">
                <a class="ui item"><button onclick="myFunction()" class="positive ui button">Create</button></a>
              </div>
            </div>

            <form class="ui form" action="${createLink(controller:'certificate', action: 'searchResults')}" method="post">
...
%{-- MODAL of COE CREATE CERTIFICATE --}%
        <div id="myModal" class="ui small modal">
              ...
              <div class="header">Create TEC Certificate</div>
            <div class="ui form">
            <form action="${createLink(controller:'certificate', action: 'save')}" method="post" >
                <fieldset class="form">
