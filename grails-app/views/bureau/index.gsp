...
<html>
    ...
    <body>
        ...
        <div class="ui secondary pointing menu">
              <a class="item active"><h3>Bureau List</h3></a>
              <div class="right menu">
                <a class="ui item"><button onclick="myFunction()" class="positive ui button">Create</button></a>
              </div>
            </div>

            <form class="ui form" action="${createLink(controller:'bureau', action: 'searchResults')}" method="post">
              <div class="ui fluid action input">
                ...
                <table class='ui celled red table'>
                  ...
                  <tbody>
                  <g:each in="${bureauList}" var="tec">
                    <tr>
                      <td><center><div style='width: 50px;word-wrap:break-word;'>${tec.id}</div></center></td>
                      <td><div style='width: 900px;word-wrap:break-word;'>${tec.bureauName}</div></td>
                  ...
                  <tfoot><tr><th colspan="8">
                    <div class="ui right floated pagination menu">
                         <g:paginate total="${bureauCount ?: 0}" params="${params}"/>
                    </div>
                  </th></tr></tfoot>
                </table>
        ...
        <div id="myModal" class="ui small modal">
              ...
              <div class="header">Create Bureau</div>
            <div class="ui form">
            <form action="${createLink(controller:'bureau', action: 'save')}" method="post" >
                <fieldset class="form">
                    <f:with bean="bureau">
                      <div class="field">
                        <input type="text" placeholder="Bureau Name" name="bureauName">
                      </div>
                    </f:with>
                      <div>
